    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "storage_key",
                    models.CharField(
                        max_length=512, unique=True, verbose_name="Ключ в хранилище"
                    ),
                ),
                (
                    "original_filename",
                    models.CharField(
                        blank=True, max_length=512, verbose_name="Исходное имя файла"
                    ),
                ),
                (
                    "mime_type",
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            (
                                "pending",
                                "Выдан presigned URL, загрузка не подтверждена",
                            ),
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Без использований с"
                    ),
                ),
                (
                    "created_at",
                ...
                (
                    "deleted_at",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Физически удалён"
                    ),
                ),
                (
                    "storage_meta",
                    models.JSONField(
                        blank=True, default=dict, verbose_name="Метаданные хранилища"
                    ),
                ),
                (
                    "owner",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "object_id",
                    models.CharField(max_length=64, verbose_name="ID сущности"),
                ),
                (
                    "role",
                    models.CharField(
        ...
        migrations.AddIndex(
            model_name="mediaasset",
            index=models.Index(
                fields=["status", "created_at"], name="core_mediaa_status_0b5c0e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="mediaasset",
            index=models.Index(
                fields=["owner", "status"], name="core_mediaa_owner_i_8f1a2d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="mediaasset",
            index=models.Index(
                fields=["ref_count", "status"], name="core_mediaa_ref_cou_9e3b1a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="mediaasset",
            index=models.Index(
                fields=["storage_backend", "status"],
                name="core_mediaa_storage_7c2d4e_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="mediaasset",
            index=models.Index(
                fields=["status", "unreferenced_since"],
                name="core_mediaa_status_2a1f8b_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="assetusage",
            index=models.Index(
                ...
                name="core_assetu_content_3d4e5f_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="assetusage",
            index=models.Index(
                fields=["asset", "role"], name="core_assetu_asset_i_6a7b8c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="assetusage",

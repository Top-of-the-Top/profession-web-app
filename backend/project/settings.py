...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": """«Профессия» — образовательная онлайн-платформа для структурированных курсов
с видеосвязью, интерактивной доской и встроенным ИИ-помощником. В продукте есть каталог
платных курсов, живые вебинары и записи, домашние задания с автоматической и ручной проверкой,
а также отдельный сценарий специальных курсов по приглашению преподавателя.

Аудитория — школьники старших классов и подростки, студенты, взрослые слушатели курсов
повышения квалификации: практические занятия с преподавателем, контроль прогресса и оплата
курсов (в том числе со стороны родителя).

Специальные курсы: преподаватель рассылает ссылку; пользователь авторизуется и подаёт заявку
на участие вместо покупки; преподаватель и модератор одобряют или отклоняют заявку. После
одобрения курс доступен без оплаты и не показывается в общем каталоге другим пользователям.

Область применения — цифровые технологии и онлайн-образование. Данное описание API относится
к бэкенду веб-приложения платформы.""",
    "VERSION": "1.0.0",
    "TAGS": [
        {
            "name": "Landing",
        ...
        {
            "name": "Applications",
            "description": "Заявки на участие в курсах",
        },
        {
            "name": "Statistics",
            "description": "Статистика по курсам и пользователям",
        },
    ],

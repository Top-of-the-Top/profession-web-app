...
SECRET_KEY = 'django-insecure-obmnrrch^19to53u#^++afuja6w4dhl4vl5=y!8l1!5whpf1fi'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'profession_db'),
        'USER': os.getenv('DB_USER', 'profession_db'),
        'PASSWORD': os.getenv('DB_PASSWORD', 'project_team_password_2026'),

...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="homework",
            index=models.Index(
                fields=["homework_number"], name="courses_hom_homewor_ed78c3_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="question",
            index=models.Index(
                fields=["question_number"], name="courses_que_questio_8747af_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="section",
            index=models.Index(
                fields=["section_number"], name="courses_sec_section_e6ec3a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="lesson",
            index=models.Index(
                fields=["lesson_number"], name="courses_les_lesson__b8f0b1_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="task",
            index=models.Index(
                fields=["task_number"], name="courses_tas_task_nu_4c830f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="users_homeworks_attempts",
            index=models.Index(
                fields=["user", "attempt_number"], name="courses_use_user_id_a6b97b_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="users_questions_answers",
            index=models.Index(
                fields=["question_answer_number"], name="courses_use_questio_c70b63_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="users_tasks_answers",
            index=models.Index(
                fields=["task_answer_number"], name="courses_use_task_an_38adfc_idx"
            ),
        ),
    ]

...
class HomeworkApiIntegrationTests(BaseTestCase):
    ...
    def setUp(self):
        ...
        self.task = Task.objects.create(
            homework=self.homework, text="Развёрнутое задание", max_points=5
        )
    ...
    def test_student_submits_and_course_author_reviews(self, m_binding, m_schedule):
        ...
        submit_payload = {
            ...
            "items": [
                ...
                {"type": "task", "id": str(self.task.task_id), "number": 1, "user_answer": "ответ"},
            ],
        }
        ...
        self.assertEqual(attempt.grade, self.question.max_points + self.task.max_points)
